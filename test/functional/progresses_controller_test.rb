...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { created: @progress.created, description: @progress.description, number: @progress.number }
    end
  ...
  test "should update progress" do
    put :update, id: @progress, progress: { created: @progress.created, description: @progress.description, number: @progress.number }
    assert_redirected_to progress_path(assigns(:progress))
  end
